/**Una T&aacute;ndem es una {@link Bicycle} con dos asientos y dos
 * pares de pedales. Se distingue de una {@link Bicycle} definida
...
public class Tandem extends Bicycle {
    ...
    */
    ...
    /**Constructor que inicializa la cantidad de velocidades
    *
    * @param gears Cantidad de velocidades.
    */
    public Tandem(int gears) {
        super(gears);
    }
  ...
  /** Manual para el usuario para manejar la tandem */
  public String manual() {
        return super.manual() + "Presione 'l' (seguido de \"Enter\")" +
        " para pedalear en los pedales de atras\n";
  }
}
